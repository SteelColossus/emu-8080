...
pub fn run_operation(
    ...
    match operation {
        ...
        Operation::Mvi(register) => {
            transfer_instructions::mvi_instruction(state, *register, get_low_data())
        }
        Operation::MviMem => transfer_instructions::mvi_mem_instruction(state, get_low_data()),
        ...
        Operation::Adi => arithmetic_instructions::adi_instruction(state, get_low_data()),
        ...
        Operation::Aci => arithmetic_instructions::aci_instruction(state, get_low_data()),
        ...
        Operation::Sui => arithmetic_instructions::sui_instruction(state, get_low_data()),
        ...
        Operation::Sbi => arithmetic_instructions::sbi_instruction(state, get_low_data()),
        ...
        Operation::Xri => logical_instructions::xri_instruction(state, get_low_data()),
        ...
        Operation::Ori => logical_instructions::ori_instruction(state, get_low_data()),
        ...
        Operation::Cpi => logical_instructions::cpi_instruction(state, get_low_data()),
