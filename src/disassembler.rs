...
pub fn disassemble_next(hex_bytes: &[u8], pc: usize) -> (Instruction, usize) {
    let program_size = hex_bytes.len();

    if program_size <= pc {
        panic!("Program counter was outside the bounds of the program.");
    }

    let op_code = hex_bytes[pc];
    let mut new_pc = pc + 1;

    let mut next_byte = || -> u8 {
        if program_size <= new_pc {
            panic!("Program counter was outside the bounds of the program.");
        }

        let byte = hex_bytes[new_pc];
        new_pc = new_pc + 1;
        byte
    };
    ...
    let instruction = match op_code {
        ...
        0b00_111_110 => Instruction::new_to_content(Operation::Mvi, Box::new(Register::A), next_byte()),
        0b00_000_110 => Instruction::new_to_content(Operation::Mvi, Box::new(Register::B), next_byte()),
        0b00_001_110 => Instruction::new_to_content(Operation::Mvi, Box::new(Register::C), next_byte()),
        0b00_010_110 => Instruction::new_to_content(Operation::Mvi, Box::new(Register::D), next_byte()),
        0b00_011_110 => Instruction::new_to_content(Operation::Mvi, Box::new(Register::E), next_byte()),
        0b00_100_110 => Instruction::new_to_content(Operation::Mvi, Box::new(Register::H), next_byte()),
        0b00_101_110 => Instruction::new_to_content(Operation::Mvi, Box::new(Register::L), next_byte()),
        0b00_110_110 => Instruction::new_to_content(Operation::Mvi, Box::new(MemoryRegisterPair::M), next_byte()),
        0b00_000_001 => {
            Instruction::new_to_content16(Operation::Lxi, Box::new(RegisterPair::BC), next_byte(), next_byte())
        }
        0b00_010_001 => {
            Instruction::new_to_content16(Operation::Lxi, Box::new(RegisterPair::DE), next_byte(), next_byte())
        }
        0b00_100_001 => {
            Instruction::new_to_content16(Operation::Lxi, Box::new(RegisterPair::HL), next_byte(), next_byte())
        }
        0b00_110_001 => {
            Instruction::new_to_content16(Operation::Lxi, Box::new(RegisterPair::SP), next_byte(), next_byte())
        }
        0b00_111_010 => Instruction::new_from(Operation::Lda, Box::new(MemoryLocation::new(next_byte(), next_byte()))),
        0b00_110_010 => Instruction::new_to(Operation::Sta, Box::new(MemoryLocation::new(next_byte(), next_byte()))),
        0b00_101_010 => Instruction::new_from(Operation::Lhld, Box::new(MemoryLocation::new(next_byte(), next_byte()))),
        0b00_100_010 => Instruction::new_to(Operation::Shld, Box::new(MemoryLocation::new(next_byte(), next_byte()))),
        ...
        0b11_000_110 => Instruction::new_content(Operation::Adi, next_byte()),
        ...
        0b11_001_110 => Instruction::new_content(Operation::Aci, next_byte()),
        ...
        0b11_010_110 => Instruction::new_content(Operation::Sui, next_byte()),
        ...
        0b11_011_110 => Instruction::new_content(Operation::Sbi, next_byte()),
        ...
        0b11_100_110 => Instruction::new_content(Operation::Ani, next_byte()),
        ...
        0b11_101_110 => Instruction::new_content(Operation::Xri, next_byte()),
        ...
        0b11_110_110 => Instruction::new_content(Operation::Ori, next_byte()),
        ...
        0b11_111_110 => Instruction::new_content(Operation::Cpi, next_byte()),
        ...
        0b11_000_011 => Instruction::new_from(Operation::Jmp, Box::new(ProgramAddress::new(next_byte(), next_byte()))),
        0b11_000_010 => jcond(Condition::NZ, next_byte(), next_byte()),
        0b11_001_010 => jcond(Condition::Z, next_byte(), next_byte()),
        0b11_010_010 => jcond(Condition::NC, next_byte(), next_byte()),
        0b11_011_010 => jcond(Condition::C, next_byte(), next_byte()),
        0b11_100_010 => jcond(Condition::PO, next_byte(), next_byte()),
        0b11_101_010 => jcond(Condition::PE, next_byte(), next_byte()),
        0b11_110_010 => jcond(Condition::P, next_byte(), next_byte()),
        0b11_111_010 => jcond(Condition::M, next_byte(), next_byte()),
        0b11_001_101 => Instruction::new_from(Operation::Call, Box::new(ProgramAddress::new(next_byte(), next_byte()))),
        0b11_000_100 => ccond(Condition::NZ, next_byte(), next_byte()),
        0b11_001_100 => ccond(Condition::Z, next_byte(), next_byte()),
        0b11_010_100 => ccond(Condition::NC, next_byte(), next_byte()),
        0b11_011_100 => ccond(Condition::C, next_byte(), next_byte()),
        0b11_100_100 => ccond(Condition::PO, next_byte(), next_byte()),
        0b11_101_100 => ccond(Condition::PE, next_byte(), next_byte()),
        0b11_110_100 => ccond(Condition::P, next_byte(), next_byte()),
        0b11_111_100 => ccond(Condition::M, next_byte(), next_byte()),
        ...
        0b11_011_011 => Instruction::new_from(Operation::In, Box::new(Port::new(next_byte()))),
        0b11_010_011 => Instruction::new_to(Operation::Out, Box::new(Port::new(next_byte()))),
...
pub fn disassemble(hex_bytes: &[u8]) {
    ...
    while pc < hex_bytes.len() {
        let byte = hex_bytes[pc];
        let (instruction, new_pc) = disassemble_next(hex_bytes, pc);

        println!("{:04X}: {:02X}    {}", pc, byte, instruction);
